...
myManageHook = composeAll . concat $
    ...
    where
		myCFloats = ["alacritty-float", "MPlayer", "mpv",
					...
					"Lxappearance", "Nitrogen", "Gnome-calculator", "xdman-Main", "Arandr", "Pavucontrol", "Xfce4-power-manager-settings", "Nm-connection-editor"]
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,0), (R,0), (U,0), (D,0)] $ spacingRaw False (Border 5 0 5 0) True (Border 0 5 0 5) True $ myLayout,
